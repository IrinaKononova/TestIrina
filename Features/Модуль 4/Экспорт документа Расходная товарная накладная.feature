...
Функционал: Экспорт документа Расходная товарная накладная 


Контекст:
	Дано Я запускаю сценарий открытия TestClient или подключаю уже существующий

Сценарий: Экспорт документа Расходная товарная накладная 
	...
	И я проверяю или создаю для плана видов характеристик "AddAttributeAndProperty" объекты:
		...
		| 'e1cib/data/ChartOfCharacteristicTypes.AddAttributeAndProperty?ref=b762b13668d0905011eb76684b9f6872' | 'False'        | ''       | 'False'    | '<Type xmlns:d2p1="http://v8.1c.ru/8.1/data/enterprise/current-config">d2p1:CatalogRef.AddAttributeAndPropertyValues</Type>' | 'ValueStorage:AQEIAAAAAAAAAO+7v3siVSJ9' | 'False'     | 'Размер'         | ''                 | ''               | ''               | '_aa59a52a77bd48d5af340a2ff98411a9' |
		| 'e1cib/data/ChartOfCharacteristicTypes.AddAttributeAndProperty?ref=b762b13668d0905011eb76684b9f6877' | 'False'        | ''       | 'False'    | '<Type xmlns:d2p1="http://v8.1c.ru/8.1/data/enterprise/current-config">d2p1:CatalogRef.AddAttributeAndPropertyValues</Type>' | 'ValueStorage:AQEIAAAAAAAAAO+7v3siVSJ9' | 'False'     | 'Цвет'           | ''                 | ''               | ''               | '_453185245f214e42a64fd25b1daf8614' |
	...
	И я проверяю или создаю для документа "ShipmentConfirmation" объекты:
		...
		| 'e1cib/data/Document.ShipmentConfirmation?ref=b76cbacb2511e57d11ebeab0dfce2225' | 'False'        | 1        | '24.02.2021 10:14:17' | 'True'   | 'e1cib/data/Catalog.Companies?ref=b762b13668d0905011eb7663e35d7964' | 'e1cib/data/Catalog.Companies?ref=b762b13668d0905011eb7674324a4a2c' | 'e1cib/data/Catalog.Partners?ref=b762b13668d0905011eb7663e35d794c' | 'Enum.ShipmentConfirmationTransactionTypes.Sales' | 'e1cib/data/Catalog.Users?ref=aa7f120ed92fbced11eb13d7279770c0' | 'e1cib/data/Catalog.BusinessUnits?ref=b762b13668d0905011eb7663e35d7958' | ''            |
	...
	И я перезаполняю для объекта табличную часть "ItemList":
		...
		| 'e1cib/data/Document.ShipmentConfirmation?ref=b76cbacb2511e57d11ebeab0dfce2225' | '6b740d3a-f1f3-4438-b524-3b974c58d992' | 'e1cib/data/Catalog.ItemKeys?ref=b762b13668d0905011eb76684b9f687e' | 'e1cib/data/Catalog.Stores?ref=b762b13668d0905011eb76684b9f6861' | 'e1cib/data/Catalog.Units?ref=b762b13668d0905011eb76684b9f687b' | 1          | 'e1cib/data/Document.SalesOrder?ref=b76cbacb2511e57d11ebeab0dfce2224' | 1                    | 'e1cib/data/Document.SalesOrder?ref=b76cbacb2511e57d11ebeab0dfce2224' | ''             | ''                       | ''                  | ''                    | ''               |

	И я перезаполняю для объекта табличную часть "RowIDInfo":
		| 'Ref'                                                                           | 'Key'                                  | 'RowID'                                | 'Quantity' | 'Basis'                                                               | 'CurrentStep'                                    | 'NextStep'                                    | 'RowRef'                                                         | 'BasisKey'                             |
		| 'e1cib/data/Document.ShipmentConfirmation?ref=b76cbacb2511e57d11ebeab0dfce2225' | '6b740d3a-f1f3-4438-b524-3b974c58d992' | 'dcdcbe9e-5743-49b6-8ca8-8e95b7ac6b89' | 1          | 'e1cib/data/Document.SalesOrder?ref=b76cbacb2511e57d11ebeab0dfce2224' | 'e1cib/data/Catalog.MovementRules?refName=SI_SC' | 'e1cib/data/Catalog.MovementRules?refName=SI' | 'e1cib/data/Catalog.RowIDs?ref=b76cbacb2511e57d11ebeab0dfce2222' | 'dcdcbe9e-5743-49b6-8ca8-8e95b7ac6b89' |
